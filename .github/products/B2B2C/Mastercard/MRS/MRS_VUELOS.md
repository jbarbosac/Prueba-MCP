# 🛫 FLUJO E2E OBLIGATORIO PARA VUELOS - MRS
...
1. Ingresar a la URL correspondiente al cliente (Austro/Ficohsa/Coopenae) | Portal MRS cargado correctamente
...
27. Validar en el Admin MRS del cliente correspondiente que los montos de millas y cash coincidan con la compra | Los valores coinciden con checkout y confirmación
28. Validar en el Admin MRS que la reserva quedó emitida automáticamente (tanto Solo Millas como Millas + Plata) | La reserva aparece como EMITIDA
...
- Millas + Plata (slider con mínimo 2875 millas - emisión automática)
...
✅ **Integridad de datos:** Consistencia entre búsqueda → disponibilidad → upsell → resumen → checkout → confirmación → admin MRS  
✅ **Cliente:** Validar acceso al admin MRS correspondiente (Austro, Ficohsa o Coopenae)  
✅ **Estado EMITIDA:** Validar que ambos modelos de pago (Solo Millas y Millas + Plata) queden EMITIDA automáticamente  
...
```
[MRS] Vuelos - [Tipo de viaje] - [Proveedor] - [Modelo de pago] - [Cliente]
```

**Ejemplos:**
- `[MRS] Vuelos - Ida y vuelta - SABRE EDIFACT - Solo Millas automático - Austro`
- `[MRS] Vuelos - Solo ida - AGGREGATOR NETACTICA - Millas + Plata manual - Ficohsa Honduras`
- `[MRS] Vuelos - Multidestino - AGGREGATOR SABRE - Solo Millas automático - Coopenae`
