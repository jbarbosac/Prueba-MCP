# 🎢 FLUJO E2E OBLIGATORIO PARA ACTIVIDADES - MRS
...
25. Ingresar al admin MRS del cliente correspondiente y buscar la reserva | Reserva localizada correctamente
...
27. Validar en el Admin MRS que la reserva quedó emitida automáticamente (tanto Solo Millas como Millas + Plata) | La reserva aparece como EMITIDA
...
✅ **Proveedor:** HotelBeds (único proveedor de actividades en MRS)  
...
```
[MRS] Actividades - [Ciudad] - [Tipo de actividad] - [Modelo de pago] - [Cliente]
```

**Ejemplos:**
- `[MRS] Actividades - Quito - City Tour - Solo Millas automático - Austro`
- `[MRS] Actividades - San José - Actividad acuática - Millas + Plata manual - Coopenae`
- `[MRS] Actividades - San Salvador - Entrada a parque - Cancelación con devolución - Ficohsa`
