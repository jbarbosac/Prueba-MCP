# 🚗 FLUJO E2E OBLIGATORIO PARA AUTOS - MRS
...
28. Validar en el admin MRS del cliente correspondiente que el valor pagado (millas y/o plata) coincida con la reserva generada, incluyendo Drop-off fee si aplica | Valores coinciden con checkout y confirmación, Drop-off fee incluido
29. Validar en el Admin MRS que la reserva quedó emitida automáticamente (tanto Solo Millas como Millas + Plata) | La reserva aparece como EMITIDA
...
✅ **Integridad de datos:** Consistencia entre búsqueda → resultado → selección proveedor → checkout → confirmación → Sabre → admin MRS  
...
✅ **Drop-off fee (cargo adicional por devolver en otro destino):** Validar que se muestre en disponibilidad, checkout, confirmación, Sabre y admin MRS cuando aplica  
...
```
[MRS] Autos - [Duración] - [Empresa] - [Modelo de pago] - [Cliente]
```

**Ejemplos:**
- `[MRS] Autos - 5 días - Hertz - Solo Millas automático - Austro`
- `[MRS] Autos - 3 días - Dollar - Millas + Plata manual - Ficohsa Honduras`
- `[MRS] Autos - 7 días - Thrifty - Dropoff diferente - Coopenae`
