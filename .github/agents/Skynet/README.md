# 🤖 Célula Skynet - Agentes QA

> Célula Skynet - Espacio para agregar agentes especializados de QA

---

## 📋 Modelos de la Célula Skynet
...
## 🚀 Cómo Agregar un Modelo a Skynet

### **Paso 1: Crear el Agente**

```powershell
# Copiar template
Copy-Item .github/templates/portal-template.md .github/agents/Skynet/MODELO_QA_Assistant.agent.md
```

**Editar y completar:**
- Nombre del agente
- Prefijo del modelo (ej: [SKY1])
- URL del portal
- País
...
New-Item .github/shared/Skynet/MODELO_COMMON_RULES.md
```
...
New-Item -ItemType Directory .github/products/Skynet/MODELO/

# Copiar templates de productos
Copy-Item .github/templates/product-template.md .github/products/Skynet/MODELO/MODELO_VUELOS.md
Copy-Item .github/templates/product-template.md .github/products/Skynet/MODELO/MODELO_HOTELES.md
...
El agente padre ya está preparado para incluir modelos de Skynet. Verifica que aparezca en:
```
...
**Mantenido por:** Equipo QA Skynet
